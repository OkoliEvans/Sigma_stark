...
fn deploy_contract(
    ...
    let overseer: ContractAddress = get_caller_address();
...
fn test_add_candidate() {
    ...
    let candidate_addr = 0x06754dbca5be2db479ddeeab1a743f3d950854ac23ad4e0d43f96b4c57dde73d
        .try_into()
        .unwrap();
    let fullname = 'Olugbenga';
    let position = 'President';
    let description = 'Outspoken';
    let start = 1701560434;

    position.print();
    let contract_address = deploy_contract(
        'Voting',70, position, address_caller, start, 100
    );
    ...
    assert(total_candidates == 1, 'incorrect num');
}
...
fn test_remove_candidate() {
    ...
    let start = 1701560434;
    let contract_address = deploy_contract(
        'Voting', 70, 'Presidential', caller, start, 900
    );
    let voting_dispatcher = IVotingTraitDispatcher { contract_address };
    let candidate_addr = 0x06754dbca5be2db479ddeeab1a743f3d950854ac23ad4e0d43f96b4c57dde73d
        .try_into()
